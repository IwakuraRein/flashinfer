...
template class CutlassMoeFCRunner<__nv_bfloat16, cutlass::int4b_t>;
#endif
...
template class CutlassMoeFCRunner<half, cutlass::int4b_t>;
#ifdef ENABLE_FP8
...
template class CutlassMoeFCRunner<__nv_fp8_e4m3, cutlass::int4b_t, half, half>;
#ifdef ENABLE_BF16
...
template class CutlassMoeFCRunner<__nv_fp8_e4m3, cutlass::int4b_t, __nv_bfloat16, __nv_bfloat16>;
template class CutlassMoeFCRunner<__nv_fp8_e4m3, cutlass::int4b_t, __nv_bfloat16, __nv_fp8_e4m3>;
#endif
#endif
#ifdef ENABLE_FP4
